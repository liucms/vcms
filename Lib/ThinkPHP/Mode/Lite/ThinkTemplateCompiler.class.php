...
class ThinkTemplateCompiler {
    ...
    public function _list($attr)
    {
        ...
        foreach($fields as $field) {//显示指定的字段
            ...
            $parseStr .= '<a href="javascript:sortBy(\''.$property[0].'\',\'{$sort}\',\''.ACTION_NAME.'\')" title="按照'.$showname[2].'{$sortType} ">'.$showname[0].'<eq name="order" value="'.$property[0].'" ><img src="../Public/images/{$sortImg}.png" width="12" height="17" border="0" align="absmiddle"></eq></a></th>';
        }
